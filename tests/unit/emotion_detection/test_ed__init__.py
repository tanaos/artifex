...
def test_emotion_detection_init(mocker: MockerFixture):
    """
    Unit test for EmotionDetection.__init__.
    Args:
    ...
    # Mock config
    mock_config = mocker.patch("artifex.models.classification.multi_class_classification.emotion_detection.config")
    mock_config.EMOTION_DETECTION_HF_BASE_MODEL = "mocked-base-model"
    ...
    # Instantiate EmotionDetection
    model = EmotionDetection(mock_synthex)
