...
def test_intent_classifier_init(mocker: MockerFixture):
    """
    Unit test for IntentClassifier.__init__.
    Args:
    ...
    # Mock config
    mock_config = mocker.patch("artifex.models.classification.multi_class_classification.intent_classifier.config")
    mock_config.INTENT_CLASSIFIER_HF_BASE_MODEL = "mocked-base-model"
    ...
    model = IntentClassifier(mock_synthex)
