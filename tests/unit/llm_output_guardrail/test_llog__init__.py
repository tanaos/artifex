...
def test_llm_output_guardrail_init(mocker: MockerFixture):
    """
    Unit test for LLMOutputGuardrail.__init__.
    Args:
    ...
    # Mock config
    mock_config = mocker.patch("artifex.models.classification.multi_label_classification.llm_output_guardrail.config")
    ...
    # Instantiate LLMOutputGuardrail
    model = LLMOutputGuardrail(mock_synthex)
